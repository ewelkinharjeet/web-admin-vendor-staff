...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="./https://qriuk.com/html/perka-preview/perka/assets/images/favicon.png">

    <!-- Font CSS -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Jost:wght@300;400;500;600;700;800;900&family=Kalnia:wght@400;500;600;700&display=swap" rel="stylesheet">
                        ...
                        <div class="shop-all-product-wrapper">
                            <div class="shop-toolbar">
                                ...
                                <div class="shop-toolbar-right-side">
                                    <button class="button-show-filter d-md-none d-block" aria-label="Product Filters Action Button" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-filters-menu">
                                        <i class="fa-solid fa-arrow-down-short-wide"></i> Filters
                                    </button>
                                    <select name="orderby" class="shop-selector-orderby" aria-label="Shop order">
                            ...
                            <div class="shop-toolbar-filter-area gap-3 mt-3  d-none d-md-flex">
                                <div class="top-filter-widget">
                                    <h5 class="top-filter-widget-title">Product Categories</h5>
                                ...
                                <div class="top-filter-widget">
                                    <h5 class="top-filter-widget-title">Filter By Price</h5>
                                    <div class="shop-sidebar-widget-list price-range-filter">
                                        <form action="#">
                                ...
                                <div class="top-filter-widget">
                                    <h5 class="top-filter-widget-title">Size</h5>
                                    <ul class="shop-sidebar-widget-list shop-sidebar-widget-list-size">
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="s1" name="s1">
                                            <label for="s1">S (3)</label>
                                        </li>
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="m1" name="m1">
                                            <label for="m1">M (2)</label>
                                        </li>
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="sx1" name="sx1">
                                            <label for="sx1">XS (4)</label>
                                        </li>
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="l1" name="l1">
                                            <label for="l1">L (2)</label>
                                        </li>
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="xl1" name="xl1">
                                            <label for="xl1">XL (4)</label>
                                        </li>
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="xxl1" name="xxl1">
                                            <label for="xxl1">XXL (1)</label>
                                        </li>
                                    </ul>
                                </div>
                                <div class="top-filter-widget">
                                    <h5 class="top-filter-widget-title">Brand</h5>
                                    <ul class="shop-sidebar-widget-list shop-sidebar-widget-list-brand">
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="amazon-essentials1" name="amazon-essentials1">
                                            <label for="amazon-essentials1">Amazon Essentials (2)</label>
                                        </li>
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="fruit-of-the-loom1" name="fruit-of-the-loom1">
                                            <label for="fruit-of-the-loom1">Fruit of the Loom (1)</label>
                                        </li>
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="hanes1" name="hanes1">
                                            <label for="hanes1">Hanes (4)</label>
                                        </li>
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="resinta1" name="resinta1">
                                            <label for="resinta1">Resinta (2)</label>
                                        </li>
                                        <li class="shop-sidebar-widget-list-item">
                                            <input type="checkbox" id="simple1" name="simple1">
                                            <label for="simple1">Simple Joys by Carter's (4)</label>
                                        </li>
                                    </ul>
                                </div>
                                <div class="top-filter-widget">
                                    <h5 class="top-filter-widget-title">Product tags</h5>
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card-thumb-area">
                                            <a href="product-details.html" class="product-card-thumb">
                                                <img class="product-card-thumb-primary" src="https://qriuk.com/html/perka-preview/perka/assets/images/products/product-1.jpg" alt="Product Image primary 1" width="340" height="320">
                                            </a>
                                        ...
                                        <div class="product-card-content">
                                            <h4 class="product-card-title">
                                                <a href="product-details.html">Fresh attractive Pour Home Vetiver</a>
                                            </h4>
                                            <div class="product-card-price">
                                                <span class="visually-hidden">Price</span>
                                                <span class="product-card-regular-price">$83.00</span>
                                            </div>
                                            <div class="product-card-list-view-action">
                                                <p class="fs-16">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce posuere metus vitae arcu imperdiet, id aliquet ante scelerisque. Sed sit amet sem vitae urna fringilla tempus.</p>
                                                <a href="product-details.html" class="btn-outline-dark btn-md">Add to Cart</a>
                                            </div>
                                            <a href="product-details.html" class="product-card-box-cart">Add to Cart</a>
                                        </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card-thumb-area">
                                            <a href="product-details.html" class="product-card-thumb">
                                                <img class="product-card-thumb-primary" src="https://qriuk.com/html/perka-preview/perka/assets/images/products/product-2.jpg" alt="Product Image primary 2" width="340" height="320">
                                            </a>
                                            <button class="product-card-action-quickview" data-bs-target="#product-modal-active" data-bs-toggle="modal">Quick View</button>
                                        ...
                                        <div class="product-card-content">
                                            <h4 class="product-card-title">
                                                <a href="product-details.html">ZenStone Wood Smoking Pipes</a>
                                            </h4>
                                            <div class="product-card-price">
                                                <span class="visually-hidden">Price</span>
                                                <span class="product-card-regular-price">$77.00</span>
                                            </div>
                                            <div class="product-card-list-view-action">
                                                <p class="fs-16">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce posuere metus vitae arcu imperdiet, id aliquet ante scelerisque. Sed sit amet sem vitae urna fringilla tempus.</p>
                                                <a href="product-details.html" class="btn-outline-dark btn-md">Add to Cart</a>
                                ...
                                <div class="col">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card-thumb-area">
                                            <a href="product-details.html" class="product-card-thumb">
                                                <img class="product-card-thumb-primary" src="https://qriuk.com/html/perka-preview/perka/assets/images/products/product-3.jpg" alt="Product Image primary 2" width="340" height="320">
                                        ...
                                        <div class="product-card-content">
                                            <h4 class="product-card-title">
                                                <a href="product-details.html">L'eau D'issey Pour Homme Vetiver</a>
                                            </h4>
                                            <div class="product-card-price">
                                                <span class="visually-hidden">Price</span>
                                ...
                                <div class="col">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card-thumb-area">
                                            <a href="product-details.html" class="product-card-thumb">
                                                <img class="product-card-thumb-primary" src="https://qriuk.com/html/perka-preview/perka/assets/images/products/product-4.jpg" alt="Product Image primary 4" width="340" height="320">
                                            </a>
                                            <button class="product-card-action-quickview" data-bs-target="#product-modal-active" data-bs-toggle="modal">Quick View</button>
                                        ...
                                        <div class="product-card-content">
                                            <h4 class="product-card-title">
                                                <a href="product-details.html">Tory Burch Cosmic Wood</a>
                                            </h4>
                                            <div class="product-card-price">
                                                <span class="visually-hidden">Price</span>
                                                <span class="product-card-old-price"><del>$47.00</del></span>
                                                <span class="product-card-regular-price">$42.00</span>
                                            </div>
                                            <div class="product-card-list-view-action">
                                                <p class="fs-16">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce posuere metus vitae arcu imperdiet, id aliquet ante scelerisque. Sed sit amet sem vitae urna fringilla tempus.</p>
                                                <a href="product-details.html" class="btn-outline-dark btn-md">Add to Cart</a>
                                ...
                                <div class="col">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card-thumb-area">
                                            <a href="product-details.html" class="product-card-thumb">
                                                <img class="product-card-thumb-primary" src="https://qriuk.com/html/perka-preview/perka/assets/images/products/product-5.jpg" alt="Product Image primary 5" width="340" height="320">
                                            </a>
                                            <button class="product-card-action-quickview" data-bs-target="#product-modal-active" data-bs-toggle="modal">Quick View</button>
                                        ...
                                        <div class="product-card-content">
                                            <h4 class="product-card-title">
                                                <a href="product-details.html">Club De Nuit Imperiale</a>
                                            </h4>
                                            <div class="product-card-price">
                                                <span class="visually-hidden">Price</span>
                                                <span class="product-card-regular-price">$71.00</span>
                                            </div>
                                            <div class="product-card-list-view-action">
                                                <p class="fs-16">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce posuere metus vitae arcu imperdiet, id aliquet ante scelerisque. Sed sit amet sem vitae urna fringilla tempus.</p>
                                                <a href="product-details.html" class="btn-outline-dark btn-md">Add to Cart</a>
                                ...
                                <div class="col">
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-card-content">
                                            <h4 class="product-card-title">
                                                <a href="product-details.html">Gift box with a red ribbon tied around it</a>
                                            </h4>
                                            <div class="product-card-price">
                                                <span class="visually-hidden">Price</span>
                                                <span class="product-card-regular-price">$42.00</span>
                                ...
                                <div class="col">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card-thumb-area">
                                            <a href="product-details.html" class="product-card-thumb">
                                                <img class="product-card-thumb-primary" src="https://qriuk.com/html/perka-preview/perka/assets/images/products/product-7.jpg" alt="Product Image primary 7" width="340" height="320">
                                            </a>
                                            <button class="product-card-action-quickview" data-bs-target="#product-modal-active" data-bs-toggle="modal">Quick View</button>
                                        ...
                                        <div class="product-card-content">
                                            <h4 class="product-card-title">
                                                <a href="product-details.html">Forever 21 Mimosa Dahlia</a>
                                            </h4>
                                            <div class="product-card-price">
                                                <span class="visually-hidden">Price</span>
                                                <span class="product-card-old-price"><del>$47.00</del></span>
                                ...
                                <div class="col">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card-thumb-area">
                                            <a href="product-details.html" class="product-card-thumb">
                                                <img class="product-card-thumb-primary" src="https://qriuk.com/html/perka-preview/perka/assets/images/products/product-8.jpg" alt="Product Image primary 8" width="340" height="320">
                                            </a>
                                            <button class="product-card-action-quickview" data-bs-target="#product-modal-active" data-bs-toggle="modal">Quick View</button>
                                        ...
                                        <div class="product-card-content">
                                            <h4 class="product-card-title">
                                                <a href="product-details.html">A beautiful glass vase of a with flowers</a>
                                            </h4>
                                            <div class="product-card-price">
                                                <span class="visually-hidden">Price</span>
                                                <span class="product-card-old-price"><del>$46.00</del></span>
                                                <span class="product-card-regular-price">$41.00</span>
                                            </div>
                                            <div class="product-card-list-view-action">
                                                <p class="fs-16">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce posuere metus vitae arcu imperdiet, id aliquet ante scelerisque. Sed sit amet sem vitae urna fringilla tempus.</p>
                                                <a href="product-details.html" class="btn-outline-dark btn-md">Add to Cart</a>
                                ...
                                <div class="col">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card-thumb-area">
                                            <a href="product-details.html" class="product-card-thumb">
                                                <img class="product-card-thumb-primary" src="https://qriuk.com/html/perka-preview/perka/assets/images/products/product-9.jpg" alt="Product Image primary 9" width="340" height="320">
                                            </a>
                                            <button class="product-card-action-quickview" data-bs-target="#product-modal-active" data-bs-toggle="modal">Quick View</button>
                                        ...
                                        <div class="product-card-content">
                                            <h4 class="product-card-title">
                                                <a href="product-details.html">Handmade flower basket</a>
                                            </h4>
                                            <div class="product-card-price">
                                                <span class="visually-hidden">Price</span>
                                                <span class="product-card-old-price"><del>$36.00</del></span>
                                                <span class="product-card-regular-price">$33.00</span>
                                            </div>
                                            <div class="product-card-list-view-action">
                                                <p class="fs-16">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce posuere metus vitae arcu imperdiet, id aliquet ante scelerisque. Sed sit amet sem vitae urna fringilla tempus.</p>
                                                <a href="product-details.html" class="btn-outline-dark btn-md">Add to Cart</a>
